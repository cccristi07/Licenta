...
\caption{Rezultate simulări}
\label{fig:ref_other}
\end{figure}

După cum se observă în \ref{fig:ref_other} zonele de regim staționar și de regim dinamic se păstrează în continuare și pentru caracteristicile de viteză și debit.


\subsection{Simulare dinamică pentru defecte în diferite noduri}

În continuare vom considera un scenariu de defect pentru rețea care constă în modificarea succesivă a parametrului de proporționalitate din relația de calcul a debitului de emitter \eqref{eq:emitter}.
